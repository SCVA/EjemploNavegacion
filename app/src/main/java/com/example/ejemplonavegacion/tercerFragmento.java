...
public class tercerFragmento extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button miTercerBoton = (Button) view.findViewById( R.id.buttonTercero );
        miTercerBoton.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController( v ).navigate( R.id.cuartoFragmento );
            }
        } );
