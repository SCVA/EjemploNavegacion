...
public class PrimerFragmento extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button miPrimerBoton = (Button) view.findViewById( R.id.buttonPrimero );
        Button miSegundoBoton = (Button) view.findViewById( R.id.buttonSegundo );
        miPrimerBoton.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate( R.id.segundoFragmento );
            }
        } );
        miSegundoBoton.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController( v ).navigate( R.id.tercerFragmento );
            }
        } );
